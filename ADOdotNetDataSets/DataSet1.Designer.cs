...
namespace ADOdotNetDataSets {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public CustomersRow AddCustomersRow(string CustomerID, string CompanyName, string ContactTitle) {
...
namespace ADOdotNetDataSets.DataSet1TableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Customers] WHERE (([CustomerID] = @Original_CustomerID) AND ([Compan" +
                "yName] = @Original_CompanyName) AND ((@IsNull_ContactTitle = 1 AND [ContactTitle" +
                "] IS NULL) OR ([ContactTitle] = @Original_ContactTitle)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Customers] ([CustomerID], [CompanyName], [ContactTitle]) VALUES (@Cu" +
                "stomerID, @CompanyName, @ContactTitle);\r\nSELECT CustomerID, CompanyName, Contact" +
                "Title FROM Customers WHERE (CustomerID = @CustomerID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Customers] SET [CustomerID] = @CustomerID, [CompanyName] = @CompanyName, [ContactTitle] = @ContactTitle WHERE (([CustomerID] = @Original_CustomerID) AND ([CompanyName] = @Original_CompanyName) AND ((@IsNull_ContactTitle = 1 AND [ContactTitle] IS NULL) OR ([ContactTitle] = @Original_ContactTitle)));
SELECT CustomerID, CompanyName, ContactTitle FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Data Source=localhost;Initial Catalog=Northwind;Integrated Security=True";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Customers.CustomerID,\r\n\tCustomers.CompanyName,\r\n\tCustomers.ContactTitle\r\nF" +
                "ROM Customers";
